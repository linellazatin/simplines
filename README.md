...
I was able to get `relatively good` results from both Qwen3.5 & Ornith1.5 - others either 'imagined' what the referenced site looked like, or hallucinated files inside cwd. Some did good use of tools, others did not. I used [pi coding agent](https://pi.dev) for all of these.

This is basically just a test, but went through with it and use it anyways.
